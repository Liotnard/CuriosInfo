...
export default function PresseList() {
  ...
  const presseList = actorList?.filter(m => (m.actor_type ?? m.actor_type ?? m.type) === "presse") || [];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mb-12 text-center max-w-2xl mx-auto">
          <h1 className="text-4xl font-display font-bold mb-4">Presse éditoriale</h1>
          <p className="text-muted-foreground">
            Médias et organes de presse surveillés et leur positionnement éditorial.
          </p>
        </div>
