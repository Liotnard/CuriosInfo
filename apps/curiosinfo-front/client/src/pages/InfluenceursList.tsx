...
export default function InfluenceursList() {
  const { data: actorList, isLoading } = useActor();
  const influenceursList = actorList?.filter(m => (m.actor_type ?? m.actor_type ?? m.type) === "influenceur") || [];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mb-12 text-center max-w-2xl mx-auto">
          <h1 className="text-4xl font-display font-bold mb-4">Influenceurs</h1>
          <p className="text-muted-foreground">
            Influenceurs et penseurs avec presence éditoriale remarquée.
          </p>
        </div>
