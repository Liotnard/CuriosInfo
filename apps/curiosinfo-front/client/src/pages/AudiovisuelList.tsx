...
export default function AudiovisuelList() {
  const { data: actorList, isLoading } = useActor();
  const AudiovisuelList = actorList?.filter(m => (m.actor_type ?? m.actor_type ?? m.type) === "audiovisuel") || [];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mb-12 text-center max-w-2xl mx-auto">
          <h1 className="text-4xl font-display font-bold mb-4">Télévision et radio</h1>
          <p className="text-muted-foreground">
            Programmes, émissions et chaînes de télévision et de radio françaises.
          </p>
        </div>
